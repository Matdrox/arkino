...
function App() {
	return (
		<div className='w-screen h-screen relative bg-slate-900 overflow-hidden'>
			...
			<div className='w-full h-full flex flex-col justify-center items-center opacity-90'>
				...
				<div className='flex gap-5 z-10'>
					<a href='mailto:cananau@kth.se'>
						<button className='w-32 h-12 text-xl rounded-md bg-purple-500 shadow-purple-500 shadow-2xl text-slate-900 z-10 transition hover:bg-orange-500 hover:shadow-orange-500'>
							Contact
						</button>
					</a>
					<button className='w-32 h-12 text-xl rounded-md border-2 border-purple-500 text-purple-500 shadow-purple-500 shadow-2xl z-10 transition hover:border-orange-500 hover:text-orange-500 hover:shadow-orange-500'>
						About
					</button>
				</div>
			</div>
